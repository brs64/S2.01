    ...
    , ui(new Ui::lecteurVue)
{
    ...
    QObject::connect(ui->pause, SIGNAL(clicked()), this, SLOT(demanderDepartArretAutodemander()));
    QObject::connect(ui->actionQuitter, SIGNAL(triggered()), this, SLOT(quitterApplication()));
    QObject::connect(ui->modeDefilement, SIGNAL(triggered()), this, SLOT(demanderPause()));
    ...
    QWidget::setTabOrder(ui->precedent, ui->pause);
    QWidget::setTabOrder(ui->pause, ui->suivant);
}
